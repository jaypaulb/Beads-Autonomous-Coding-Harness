...
def create_client(project_dir: Path, model: str) -> ClaudeSDKClient:
    ...
    print("   - Beads (bd) CLI: local issue tracking")
    print()

    return ClaudeSDKClient(
        options=ClaudeCodeOptions(
            model=model,
            system_prompt="You are an expert full-stack developer building a production-quality web application. You use Beads (bd) for local issue tracking and work management.",
            allowed_tools=[
                *BUILTIN_TOOLS,
                *PUPPETEER_TOOLS,
            ],
