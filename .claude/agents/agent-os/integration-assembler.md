...
When working in the Linear-Coding-Agent-Harness project:

### Absolute Paths Only
- **All shell commands MUST use absolute paths**
- **The `cd` command is FORBIDDEN**
- **The `cwd=` parameter in subprocess is FORBIDDEN**
...
- `.beads/` exists ONLY at harness root
- Never create `.beads/` in spec directories
